...
```js
var zip = new JSZip();
zip.folder("film/Pierre/videos");
zip.folder("film/Pierre/photos");
zip.folder("film/Jean/videos");
zip.folder("film/Jean/photos");

zip.folder(/videos/); // array of size 2

zip.folder("film/Jean").folder(/^vid/); // array of 1
```
